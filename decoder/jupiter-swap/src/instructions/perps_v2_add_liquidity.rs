...
#[indexer(discriminator = "0x124258c2c53474d4")]
pub struct PerpsV2AddLiquidity {}

pub struct PerpsV2AddLiquidityInstructionAccounts {
...
impl solana_indexer_core::deserialize::ArrangeAccounts for PerpsV2AddLiquidity {
...
fn arrange_accounts(
        ...
        Some(PerpsV2AddLiquidityInstructionAccounts {
