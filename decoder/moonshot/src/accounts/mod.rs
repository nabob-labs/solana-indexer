...
mod tests {
    ...
    fn test_decode_config_account() {
        ...
        let account = solana_indexer_test_utils::read_account("tests/fixtures/config_account.json")
            .expect("read fixture");
    ...
    fn test_decode_curve_account() {
        ...
        // Act
        let decoder = MoonshotDecoder;
        let account = solana_indexer_test_utils::read_account("tests/fixtures/curve_account.json")
            .expect("read fixture");
        let decoded_account = decoder.decode_account(&account).expect("decode fixture");
