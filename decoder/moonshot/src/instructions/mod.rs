...
#[derive(
    solana_indexer_core::InstructionType, serde::Serialize, serde::Deserialize, PartialEq, Eq, Debug, Clone,
)]
...
impl solana_indexer_core::instruction::InstructionDecoder<'_> for MoonshotDecoder {
...
mod tests {
    ...
    fn test_decode_token_mint() {
        ...
        let instruction = solana_indexer_test_utils::read_instruction("tests/fixtures/token_mint_ix.json")
            .expect("read fixture");
        let decoded = decoder
    ...
    fn test_decode_buy() {
        ...
        // Act
        let decoder = MoonshotDecoder;
        let instruction = solana_indexer_test_utils::read_instruction("tests/fixtures/buy_ix.json")
            .expect("read fixture");
        let decoded = decoder
            .decode_instruction(&instruction)
            .expect("decode instruction");
    ...
    fn test_decode_sell() {
        ...
        // Act
        let decoder = MoonshotDecoder;
        let instruction = solana_indexer_test_utils::read_instruction("tests/fixtures/sell_ix.json")
            .expect("read fixture");
        let decoded = decoder
            .decode_instruction(&instruction)
            .expect("decode instruction");
    ...
    fn test_decode_migrate_funds() {
        ...
        let decoder = MoonshotDecoder;
        let instruction =
            solana_indexer_test_utils::read_instruction("tests/fixtures/migrate_funds_ix.json")
                .expect("read fixture");
        let decoded = decoder
            .decode_instruction(&instruction)
            .expect("decode instruction");
