...
#[indexer(discriminator = "0x925d0ea79f14063a")]
...
pub struct PlaceOrderV3InstructionAccounts {
...
impl solana_indexer_core::deserialize::ArrangeAccounts for PlaceOrderV3 {
    type ArrangedAccounts = PlaceOrderV3InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(PlaceOrderV3InstructionAccounts {
            state: state.pubkey,
