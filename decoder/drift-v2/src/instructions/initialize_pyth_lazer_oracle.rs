...
#[indexer(discriminator = "0x8c6b21d6ebdb6714")]
...
pub struct InitializePythLazerOracleInstructionAccounts {
    ...
    pub lazer_oracle: solana_sdk::pubkey::Pubkey,
    pub state: solana_sdk::pubkey::Pubkey,
    pub rent: solana_sdk::pubkey::Pubkey,
    pub system_program: solana_sdk::pubkey::Pubkey,
}

impl solana_indexer_core::deserialize::ArrangeAccounts for InitializePythLazerOracle {
