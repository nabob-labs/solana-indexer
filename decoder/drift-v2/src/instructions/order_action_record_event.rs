...
#[indexer(discriminator = "0xe445a52e51cb9a1de0344347c2ed6d01")]
pub struct OrderActionRecordEvent {
    ...
    pub filler: Option<solana_sdk::pubkey::Pubkey>,
    ...
    pub taker: Option<solana_sdk::pubkey::Pubkey>,
    ...
    pub maker: Option<solana_sdk::pubkey::Pubkey>,
