...
#[indexer(discriminator = "0x537da645f7fc6785")]
...
pub struct EndAndCloseInstructionAccounts {
    ...
    pub init_user_out_ata: solana_pubkey::Pubkey,
...
impl solana_indexer_core::deserialize::ArrangeAccounts for EndAndClose {
