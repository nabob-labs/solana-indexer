...
impl<'a> solana_indexer_core::instruction::InstructionDecoder<'a> for FluxbeamDecoder {
...
mod tests {
    ...
    fn test_decode_initialize() {
        ...
        let instruction = solana_indexer_test_utils::read_instruction("tests/fixtures/initialize_ix.json")
            .expect("read fixture");
        let decoded = decoder
    ...
    fn test_decode_swap() {
        ...
        // Act
        let decoder = FluxbeamDecoder;
        let instruction = solana_indexer_test_utils::read_instruction("tests/fixtures/swap_ix.json")
            .expect("read fixture");
        let decoded = decoder
            .decode_instruction(&instruction)
            .expect("decode instruction");
    ...
    fn test_decode_withdraw_all_token_types() {
        ...
        let decoder = FluxbeamDecoder;
        let instruction =
            solana_indexer_test_utils::read_instruction("tests/fixtures/withdraw_all_token_types_ix.json")
                .expect("read fixture");
        let decoded = decoder
            .decode_instruction(&instruction)
            .expect("decode instruction");
