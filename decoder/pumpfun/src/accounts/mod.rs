...
mod tests {
    ...
    fn test_decode_bonding_curve_account() {
        ...
        let account = solana_indexer_test_utils::read_account("tests/fixtures/bonding_curve_account.json")
            .expect("read fixture");
    ...
    fn test_decode_global_account() {
        ...
        // Act
        let decoder = PumpfunDecoder;
        let account = solana_indexer_test_utils::read_account("tests/fixtures/global_account.json")
            .expect("read fixture");
        let decoded_account = decoder.decode_account(&account).expect("decode fixture");
    ...
    fn test_decode_last_withdraw_account() {
        ...
        // Act
        let decoder = PumpfunDecoder;
        let account = solana_indexer_test_utils::read_account("tests/fixtures/last_withdraw_account.json")
            .expect("read fixture");
        let decoded_account = decoder.decode_account(&account).expect("decode fixture");
