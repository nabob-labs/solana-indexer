...
mod tests {
    ...
    fn test_decode_create() {
        ...
        // Act
        let decoder = PumpfunDecoder;
        let instruction = solana_indexer_test_utils::read_instruction("tests/fixtures/create_ix.json")
            .expect("read fixture");
        let decoded = decoder
            .decode_instruction(&instruction)
            .expect("decode instruction");
    ...
    fn test_decode_withdraw() {
        ...
        // Act
        let decoder = PumpfunDecoder;
        let instruction = solana_indexer_test_utils::read_instruction("tests/fixtures/withdraw_ix.json")
            .expect("read fixture");
        let decoded = decoder
            .decode_instruction(&instruction)
            .expect("decode instruction");
