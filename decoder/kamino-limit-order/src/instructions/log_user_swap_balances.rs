...
#[indexer(discriminator = "0x23765f4de72e8026")]
...
impl solana_indexer_core::deserialize::ArrangeAccounts for LogUserSwapBalances {
    type ArrangedAccounts = LogUserSwapBalancesInstructionAccounts;

    fn arrange_accounts(
        accounts: &[solana_instruction::AccountMeta],
    ) -> Option<Self::ArrangedAccounts> {
        let [maker, input_mint, output_mint, input_ta, output_ta, event_authority, program, _remaining @ ..] =
            accounts
        else {
            return None;
        };
