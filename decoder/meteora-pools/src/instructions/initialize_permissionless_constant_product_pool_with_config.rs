...
#[indexer(discriminator = "0x07a68aabceabecf4")]
pub struct InitializePermissionlessConstantProductPoolWithConfig {
    pub token_a_amount: u64,
    pub token_b_amount: u64,
}

pub struct InitializePermissionlessConstantProductPoolWithConfigInstructionAccounts {
...
impl solana_indexer_core::deserialize::ArrangeAccounts
    for InitializePermissionlessConstantProductPoolWithConfig
{
    type ArrangedAccounts =
        InitializePermissionlessConstantProductPoolWithConfigInstructionAccounts;
