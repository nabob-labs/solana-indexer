...
//!
//! These components enable the `indexer-core` framework to handle Solana transaction instructions efficiently,
//! decoding them into structured types and facilitating hierarchical processing.

use crate::{
    error::IndexerResult, metrics::MetricsCollection, processor::Processor,
