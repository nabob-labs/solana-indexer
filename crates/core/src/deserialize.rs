...
//! # Overview
//!
//! - **`IndexerDeserialize`**: A trait for custom deserialization of data
...
//! # Notes
//!
//! - The `IndexerDeserialize` trait requires implementers to also implement
...
/// Implements the `IndexerDeserialize` trait for `PrefixString`.
