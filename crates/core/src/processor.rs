//! Defines the `Processor` trait for processing data within the `indexer-core` pipeline.
//!
...
//! ## Returns
//!
//! The `process` method returns a `IndexerResult<()>`, which indicates either successful processing
//! (`Ok(())`) or an error.
//!
//! ## Notes
//!
