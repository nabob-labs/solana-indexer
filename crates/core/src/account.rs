...
//! `indexer-core` pipeline. It provides abstractions for decoding accounts, processing account
...
use crate::{error::IndexerResult, metrics::MetricsCollection, processor::Processor};
