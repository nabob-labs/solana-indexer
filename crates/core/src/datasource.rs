...
//! with the `indexer-core` processing pipeline.
//!
//! # Overview
//!
...
///     ) -> IndexerResult<tokio::task::AbortHandle> {
...
/// Represents a data update in the `indexer-core` pipeline, encompassing different update types.
///
